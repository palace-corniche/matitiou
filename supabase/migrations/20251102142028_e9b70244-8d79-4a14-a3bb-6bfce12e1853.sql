-- ============================================
-- CRITICAL FIX: Entry Price for JSONB version
-- ============================================
-- Fix the JSONB version of execute_advanced_order that's actually being used

DROP FUNCTION IF EXISTS execute_advanced_order(UUID, JSONB);
