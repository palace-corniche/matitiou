-- Fix column names in execute_advanced_order (bid/ask instead of bid_price/ask_price)
...
BEGIN
  ...
  -- Get latest tick data - FIXED: use 'bid' and 'ask' columns
  ...
  -- Use real bid/ask from tick_data - FIXED: reference v_tick.bid and v_tick.ask
