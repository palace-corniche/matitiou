-- Insert test trading signals for validation with corrected numeric values
...
(
    'test_signal_001', 'EUR/USD', 'buy', 75, 8, 0.82, 
...
(
    'test_signal_002', 'EUR/USD', 'sell', 68, 7, 0.75, 
...
-- Insert test rejection logs for analytics with corrected numeric values
INSERT INTO signal_rejection_logs (
    signal_type, reason, value, threshold, factors_count, 
    confluence_score, market_regime
) VALUES 
('buy', 'low_confluence_score', 0.45, 0.50, 3, 45, 'trending'),
('sell', 'insufficient_entropy', 0.20, 0.30, 5, 62, 'ranging'),
('buy', 'edge_threshold_not_met', 0.01, 0.10, 4, 55, 'volatile');
